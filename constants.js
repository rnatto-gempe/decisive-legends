    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                description:
                    "Você absorve conhecimentos arcanos de sua versão mágica.",
                effectDisplay:
        ...
        options: [
            {
                ...
                effect: { attack: 2, health: -10 },

                description: "Você ganha +2 de ataque, mas perde 10 de vida.",

                effectDisplay:
                    "<span class='option-effect option-positive'>+2 ATK</span> <span class='option-effect option-negative'>-10 HP</span>"
            },

            {
                text: "Atravessar a ponte instável",

                effect: { defense: 3, attack: -1 },

                description: "Você ganha +3 de defesa, mas perde 1 de ataque.",

                effectDisplay:
                    "<span class='option-effect option-positive'>+3 DEF</span> <span class='option-effect option-negative'>-1 ATK</span>"
            }
        ]
    },
